...
const DOC1_REVIEW: ReviewResult = {
  ...
  signals: [
    { signalId: 'clarity', score: 90, rationale: 'Reads cleanly on a first pass; premise and format are immediately clear.', issues: [] },
    { signalId: 'completeness', score: 90, rationale: 'Premise, audience (kids 6-12), format (6-minute YouTube pilot), and lead are all present.', issues: [] },
    { signalId: 'brand_safety', score: 100, rationale: 'Warm, gentle, and fully family-safe.', issues: [] },
    { signalId: 'hook_strength', score: 90, rationale: 'A secret midnight room-service operation is an instant, scroll-stopping hook.', issues: [] },
    { signalId: 'character', score: 80, rationale: 'Eloise is specific and ownable, with a clear want and a streak of mischief.', issues: [] },
    { signalId: 'franchise_fit', score: 90, rationale: 'Playful, upscale-Manhattan, family tone — squarely in the Eloise world.', issues: [] },
  ],
...
const DOC2_REVIEW: ReviewResult = {
  ...
  signals: [
    ...
    { signalId: 'completeness', score: 40, rationale: 'No audience, format, or concrete character traits.', issues: [] },
    { signalId: 'brand_safety', score: 90, rationale: 'Nothing unsafe or off-brand.', issues: [] },
    { signalId: 'hook_strength', score: 60, rationale: 'A friend-or-rival premise is a serviceable hook but underdeveloped.', issues: [] },
    { signalId: 'character', score: 30, rationale: 'Described by vibe, with no specific trait, want, or quirk.', issues: [] },
    { signalId: 'franchise_fit', score: 60, rationale: 'Plausibly fits the Plaza world, but too thin to be sure.', issues: [] },
  ],
...
const DOC3_REVIEW: ReviewResult = {
  ...
  signals: [
    { signalId: 'clarity', score: 70, rationale: 'The plot is easy to follow.', issues: [] },
    { signalId: 'completeness', score: 70, rationale: 'Premise, lead, stakes, and tone are all stated.', issues: [] },
    {
    ...
    { signalId: 'hook_strength', score: 70, rationale: 'A haunted elevator is a strong hook — but in the wrong register for this brand.', issues: [] },
    { signalId: 'character', score: 60, rationale: 'Eloise still reads as herself: resourceful and brave.', issues: [] },
    { signalId: 'franchise_fit', score: 40, rationale: 'A horror tone with a body count clashes with the playful, family-safe Eloise world.', issues: [] },
  ],
...
const DOC5_REVIEW: ReviewResult = {
  ...
  signals: [
    { signalId: 'clarity', score: 80, rationale: 'The premise and its events read clearly on a first pass.', issues: [] },
    {
    ...
    { signalId: 'brand_safety', score: 90, rationale: 'Lighthearted competition with nothing unsafe or off-brand.', issues: [] },
    { signalId: 'hook_strength', score: 70, rationale: 'A hotel-wide Mini Olympics with invented events is a fun, scroll-stopping hook.', issues: [] },
    { signalId: 'character', score: 70, rationale: 'Eloise drives the chaos with her signature take-charge mischief.', issues: [] },
    { signalId: 'franchise_fit', score: 80, rationale: 'Playful, upscale-Manhattan ensemble comedy — right in the Eloise world.', issues: [] },
  ],
...
const DOC7_REVIEW: ReviewResult = {
  ...
  signals: [
    ...
    { signalId: 'completeness', score: 60, rationale: 'World-building doc is noted as such, but lacks a suggested format for how this would appear on screen.', issues: [] },
    { signalId: 'brand_safety', score: 90, rationale: 'Whimsical and gentle, with nothing unsafe for a family audience.', issues: [] },
    { signalId: 'hook_strength', score: 50, rationale: 'Strong atmosphere but no clear hook for a 6-year-old viewer.', issues: [] },
    { signalId: 'character', score: 50, rationale: 'No specific character introduced in this document.', issues: [] },
    { signalId: 'franchise_fit', score: 70, rationale: 'The magical depth beneath the comedy fits the upscale, whimsical Eloise world.', issues: [] },
  ],
  verdict: { label: 'needs_work', flagCount: 3 },
  summary:
...
const DOC8_REVIEW: ReviewResult = {
  ...
  signals: [
    { signalId: 'clarity', score: 90, rationale: 'The strategy, format, and metrics read cleanly on a first pass.', issues: [] },
    { signalId: 'completeness', score: 100, rationale: 'Premise, audience, format, cast, distribution, and success metric are all specified.', issues: [] },
    { signalId: 'brand_safety', score: 100, rationale: 'Entirely family-safe and on-brand for ages 6-12.', issues: [] },
    { signalId: 'hook_strength', score: 80, rationale: 'A clear digital-first launch with a recurring signature bit is compelling.', issues: [] },
    { signalId: 'character', score: 90, rationale: 'Eloise and her recurring cast are specific, distinct, and franchise-ready.', issues: [] },
    { signalId: 'franchise_fit', score: 100, rationale: 'Playful, mischievous, upscale-Manhattan whimsical — exactly the Eloise brand.', issues: [] },
  ],
  verdict: { label: 'looks_ready', flagCount: 0 },
  summary:
