// POST /api/review — its sole job is to keep the provider API key off the client.
// It parses the JSON body, delegates to handleReview (the testable core), and
// serializes the typed ReviewResponse. It stores nothing.
//
